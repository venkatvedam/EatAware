...
RSpec.describe DishesController, type: :controller do
  ...
  it "filters by restaurant" do
    test_dish = Dish.new(name: "test_dish", restaurant_id: 1)
    second_dish = Dish.new(name: "second_dish", restaurant_id: 2)
    test_dish.save
    second_dish.save
  ...
  it "creates a dish" do
    post :create, restaurant_id: 1, name: "Sandwich", format: :json
